...
- **QA Expertise:** Functional & Regression Testing, Test Plan Development, Defect Tracking.
- **Tools:** Jira, Trello, System Documentation.

**IT Infrastructure & Network Security**
![Cisco](https://shields.io)
![Windows Server](https://shields.io)
- **Networking:** CCNA (Cisco Certified Network Associate).
- **Systems:** MCSA (Microsoft Certified Solutions Associate).
- **Support:** Troubleshooting, Network Maintenance, Desktop Support.

---

### 📊 GitHub Stats
![Ameen's GitHub stats](https://vercel.app)
...
- 📞 **Phone:** +967777907529
- 📬 Telegram:http://t.me/AmeenNasser
